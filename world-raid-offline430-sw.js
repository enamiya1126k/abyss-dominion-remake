const CACHE='abyss-world-offline-build430';
...
self.addEventListener('fetch',event=>{
 ...
 if(r.mode==='navigate'){event.respondWith((async()=>{try{return await fetch(r);}catch{return await (await caches.open(CACHE)).match(new URL('index.html',base).href)||Response.error();}})());return;}
