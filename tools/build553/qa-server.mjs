...
const push=id=>{const g=current();send(id,{type:'raceState451',selfId:id,serverNow:now,ricochetVersion550:4,partyResultActions490:1,available:true,ricochet:g?ricochetSnapshot550(c,g,id):null,party:P.partyView462(c,c.sessions.get(id))})};
