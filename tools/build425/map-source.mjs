...
fs.writeFileSync('tools/build425/native-source-map.json',JSON.stringify(map));fs.writeFileSync('tools/build425/source-identity.json',JSON.stringify({main_sha256:createHash('sha256').update(source).digest('hex')}));
