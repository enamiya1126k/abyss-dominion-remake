...
const request=(id,op,extra={})=>c.handle(c.sessions.get(id),{op,rulesVersion:8,hideVersion536:2,roster,displayName:names[Number(id.slice(1))],...extra});
