...
mkdirSync(new URL('../../docs/build533/',import.meta.url),{recursive:true});writeFileSync(new URL('../../docs/build533/balance.json',import.meta.url),JSON.stringify({note:'Same-seed solo deterministic timing policies; 2-minute matches. No input delay, not real-player evidence.',compare},null,2));console.log(JSON.stringify(compare,null,2));
