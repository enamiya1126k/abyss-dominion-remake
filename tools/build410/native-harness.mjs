...
const expected=JSON.parse(fs.readFileSync(new URL('./source-identity.json',import.meta.url),'utf8'));if(createHash('sha256').update(source).digest('hex')!==expected.main_sha256)throw new Error('This harness requires the exact Build410 main.js recorded in source-identity.json');
