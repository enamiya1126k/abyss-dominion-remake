...
fs.writeFileSync('tools/build428/native-source-map.json',JSON.stringify(map));fs.writeFileSync('tools/build428/source-identity.json',JSON.stringify({main_sha256:createHash('sha256').update(source).digest('hex')}));
