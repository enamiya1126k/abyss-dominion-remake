...
const root=resolve(fileURLToPath(new URL('../../',import.meta.url))),runtime=process.env.RUNTIME547??resolve(root,'../runtime546');
const html=`<!doctype html><html lang="ja"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Build547 · cart input verification</title><style>@font-face{font-family:'Noto Sans JP';src:url('/qa/font.ttf')}html,body{margin:0;background:#102e27;font:14px 'Noto Sans JP',sans-serif}button,input{font:inherit}</style><link rel="stylesheet" href="/src/Styles/build543-cart.css"><link rel="stylesheet" href="/src/Styles/build544-cart.css"><link rel="stylesheet" href="/src/Styles/build545-minigames.css"><link rel="stylesheet" href="/src/Styles/build547-cart-sling.css"><script type="importmap">{"imports":{"/src/sugoroku/Wallet474.js":"/qa/unused-wallet.js"}}</script><main id="app"></main><script type="module" src="/tools/build547/preview.mjs"></script></html>`;
...
server.listen(8547,'127.0.0.1',()=>console.log('cart547 QA ready'));process.on('SIGTERM',()=>{clearInterval(timer);wss.close();server.close();process.exit()});
