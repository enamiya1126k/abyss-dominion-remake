...
server.listen(8557,'127.0.0.1',()=>console.log('cart556 QA ready'));process.on('SIGTERM',()=>{clearInterval(timer);wss.close();server.close();process.exit()});
