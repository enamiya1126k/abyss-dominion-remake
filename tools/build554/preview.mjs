...
const c=window.c={root,transport:{selfId:id},state:{},offset:0,error:'',rewardError:'',draft:{code:''},save:{state:{party:[],monsters:[],player:{gold:0,crystals:0}}},
 ...
 raw(op,payload={}){if(socket.readyState!==1)return false;(window.sent550??=[]).push({op,...payload});socket.send(JSON.stringify({op,rulesVersion:8,ricochetVersion550:5,cartVersion543:5,...payload}));return true},
