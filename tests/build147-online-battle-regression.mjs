...
assert.match(server,/protocol:"1\.[2-6]\.0"/);assert.match(server,/battleAction/);assert.match(server,/battleClock/);
...
assert.match(index,/ASSET_BUILD = "build(?:14[7-9]|15[0-9]|16[01])"/);
