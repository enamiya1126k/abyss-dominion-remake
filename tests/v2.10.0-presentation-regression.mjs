...
assert.match(main,/enemyLoadoutVersion:5/);
assert.match(main,/prepared=e\.enemyLoadoutVersion===5\?e:prepareEnemyEntry/,"current v5 loadouts stay stable while older layouts reroll onto the stronger curve");
