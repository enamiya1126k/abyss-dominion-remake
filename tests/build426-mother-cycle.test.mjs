...
async function fixture(team=ids){return run(team,[],{inspect:true,level:6000,gear:true,enemyUnits:[boss()],battleOptions:{specialBattle:true,specialBattleType:'mother422',motherDial424:{lastRound:1,index:7}}});}
