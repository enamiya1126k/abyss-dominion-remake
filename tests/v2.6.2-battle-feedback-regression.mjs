...
assert.match(index,/const ASSET_VERSION = "2\.6\.2"/);
...
assert.match(main,/modal\.classList\.add\("battle-detail-modal"\)/);
assert.match(main,/bindBackdropTapClose\(modal,\(\)=>modal\.remove\(\)\)/);

console.log("ABYSS DOMINION v2.6.2 battle feedback regression: PASS");
