...
test("build301 all active secret-room consumers use the current cache identity",async()=>{
 ...
 for(const source of files)assert.match(source,/SecretRoomSystem\.js\?v=3\.0\.1-build301/);
});
