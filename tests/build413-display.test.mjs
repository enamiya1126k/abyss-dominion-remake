...
test('latest cache targets and CSS ordering preserve Build412 logic',()=>{
 ...
 for(const p of ['core/config','core/MagicCircleSystem','ui/BattleBossLayout'])assert.equal(m[`./src/${p}.js`],`./src/${p}.js?v=${p==='core/config'?'3.1.110-build431':p==='ui/BattleBossLayout'?'3.1.104-build425':'3.1.93-build413'}`);
