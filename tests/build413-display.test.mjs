...
test('latest cache targets and CSS ordering preserve Build412 logic',()=>{
 ...
 for(const p of ['core/config','core/MagicCircleSystem','ui/BattleBossLayout'])assert.equal(m[`./src/${p}.js`],`./src/${p}.js?v=${p==='core/config'?'3.1.101-build422':'3.1.93-build413'}`);
