...
test('latest cache targets and CSS ordering preserve Build412 logic',()=>{
 ...
 for(const p of ['core/config','core/MagicCircleSystem','ui/BattleBossLayout'])assert.equal(m[`./src/${p}.js`],`./src/${p}.js?v=${['core/config','ui/BattleBossLayout'].includes(p)?'3.1.103-build424':'3.1.93-build413'}`);
