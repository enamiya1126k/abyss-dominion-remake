import{createMonster,calculatedStats}from"../models/Monster.js?v=2.7.0";
import{allLearnedSkills,maxMp}from"../battle/SkillSystem.js?v=2.7.0";
import{SPECIES}from"../data/species.js?v=2.7.0";
import{ENDGAME_BOSSES}from"./EndgameSystem.js?v=2.7.0";
import{MONSTER_STORAGE_CAP}from"./config.js?v=2.7.0";
