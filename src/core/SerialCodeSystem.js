import {validateGmFinalePack,applyGmFinalePack} from './GmFinalePackSystem.js?v=3.1.45-build365';
import{EQUIPMENT_BASES}from"../data/equipment.js?v=2.11.2-build166";
import{createMonster,calculatedStats}from"../models/Monster.js?v=3.1.45-build365";
...
import{MONSTER_STORAGE_CAP}from"./config.js?v=3.1.45-build365";
