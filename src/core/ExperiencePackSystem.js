import{TRUE_MAX_LEVEL}from"./config.js?v=2.11.2-build166";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=2.11.2-build166";
