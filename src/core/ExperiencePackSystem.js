import{TRUE_MAX_LEVEL}from"./config.js?v=2.10.0-build163";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=2.10.0-build163";
