import{TRUE_MAX_LEVEL}from"./config.js?v=3.0.5-build305";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=3.0.5-build305";
