import{TRUE_MAX_LEVEL}from"./config.js?v=3.1.40-build360";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=3.1.40-build360";
