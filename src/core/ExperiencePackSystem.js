import{TRUE_MAX_LEVEL}from"./config.js?v=3.1.37-build357";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=3.1.37-build357";
