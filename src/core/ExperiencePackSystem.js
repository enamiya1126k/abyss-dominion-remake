import{TRUE_MAX_LEVEL}from"./config.js?v=3.1.61-build381";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=3.1.61-build381";
