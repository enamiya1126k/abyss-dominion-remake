import{TRUE_MAX_LEVEL}from"./config.js?v=3.1.57-build377";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=3.1.57-build377";
