import{TRUE_MAX_LEVEL}from"./config.js?v=3.1.45-build365";
import{applyTotalExperience,experienceBeforeLevel,experienceCrystalValue,totalExperience}from"../models/Monster.js?v=3.1.45-build365";
