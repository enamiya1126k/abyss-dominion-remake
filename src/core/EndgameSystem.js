import{ENDGAME_CHARACTERS,ENDGAME_LEGACY_ID_MAP,canonicalEndgameId,endgameCharacter}from"../data/endgameCharacters.js?v=2.10.0-build158";
...
export function createEndgameTrialEncounter(state,number=normalizeEndgameState(state).trials.battle){
 // build158: 奈落回廊はプレイヤーの最高到達階を参照しない固定難度。
