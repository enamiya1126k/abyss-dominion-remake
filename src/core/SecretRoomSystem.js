...
import{createMonster,calculatedStats,displayName}from"../models/Monster.js?v=3.1.41-build361";
...
import{MONSTER_STORAGE_CAP,premiumCrystalCost}from"./config.js?v=3.1.41-build361";
import{campaignFloorToLegacyFloor}from"./Campaign100System.js?v=3.1.41-build361";
