...
import{createMonster,calculatedStats,displayName}from"../models/Monster.js?v=3.1.61-build381";
...
import{MONSTER_STORAGE_CAP,premiumCrystalCost}from"./config.js?v=3.1.61-build381";
