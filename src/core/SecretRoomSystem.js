...
import{createMonster,calculatedStats,displayName}from"../models/Monster.js?v=3.1.28-build348";
...
import{MONSTER_STORAGE_CAP,premiumCrystalCost}from"./config.js?v=3.1.28-build348";
