...
import{createMonster,calculatedStats,displayName}from"../models/Monster.js?v=3.1.37-build357";
import{allLearnedSkills,maxMp,recommendedSkills,skillMasteryNeedForLevel}from"../battle/SkillSystem.js?v=3.1.37-build357";
import{SPECIES}from"../data/species.js?v=3.1.37-build357";
import{receiveEquipment,EQUIPMENT_LIMIT,RESERVE_LIMIT,slotLabel}from"../services/EquipmentStorage.js?v=3.1.34-build354";
...
import{MONSTER_STORAGE_CAP,premiumCrystalCost}from"./config.js?v=3.1.37-build357";
