...
import{createMonster,calculatedStats,displayName}from"../models/Monster.js?v=3.1.55-build375";
...
import{MONSTER_STORAGE_CAP,premiumCrystalCost}from"./config.js?v=3.1.55-build375";
