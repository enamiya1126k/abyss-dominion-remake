...
export const FULL_RESET_WARNING=[
 ...
 "オンラインサーバーへ本人確認を行い、今週のレイド討伐・貢献・報酬記録も同時に初期化します。通信できない場合はゲームデータを変更せず中止します。",
 "オンラインのフレンドID・フレンド／ギルド関係・固定サーバーURLは、この端末の接続情報として保持されます。",
...
export const FULL_RESET_FINAL_WARNING="最終確認：ゲーム本体の全セーブ・シリアルコード使用履歴・今週のレイド記録を初期化します。元に戻せません。実行しますか？";
