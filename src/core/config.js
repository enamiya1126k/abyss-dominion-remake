...
export const SAVE_SCHEMA_VERSION=83;// Regression history: SAVE_SCHEMA_VERSION=82 / SAVE_SCHEMA_VERSION=81 / SAVE_SCHEMA_VERSION=80 / SAVE_SCHEMA_VERSION=79 / SAVE_SCHEMA_VERSION=78 / SAVE_SCHEMA_VERSION=77
...
export const APP_VERSION="3.1.6";// Regression history: APP_VERSION="3.1.5" / APP_VERSION="3.1.4" / APP_VERSION="3.1.3"
