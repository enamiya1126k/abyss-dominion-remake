import{bossProfileForFloor,post9000DepthProfile}from"../core/EnemyScalingSystem.js?v=2.1.0-release";
import{endgameCharacter,endgameSkillById}from"../data/endgameCharacters.js?v=2.1.0-release";
