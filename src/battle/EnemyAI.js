import{bossProfileForFloor,post9000DepthProfile}from"../core/EnemyScalingSystem.js?v=2.3.0";
import{endgameCharacter,endgameSkillById}from"../data/endgameCharacters.js?v=2.3.0";
