  ...
  return`
    <section class="screen">
      ...
      <div class="page">
        ...
        <div class="panel version-panel"><div><small class="muted">ABYSS DOMINION</small><h3>REMAKE v${APP_VERSION}</h3><small class="muted">正式リリース / GOLD経済・真エンディング実装</small></div></div>
