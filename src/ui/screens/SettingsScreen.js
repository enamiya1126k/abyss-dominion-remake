import{APP_VERSION,CONTENT_TEST_MODE,CONTENT_TEST_UNLOCK_FLOOR}from"../../core/config.js?v=2.10.0-build161";
import{SERIAL_CODE_COUNT}from"../../core/SerialCodeSystem.js?v=2.10.0-build161";
