  ...
  return`
    <section class="screen">
      ...
      <div class="page">
        ...
        <div class="panel version-panel"><div><small class="muted">ABYSS DOMINION</small><h3>REMAKE v${APP_VERSION}</h3><small class="muted">alpha96・97 GOLD装備厳選</small></div></div>
