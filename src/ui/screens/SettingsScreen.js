import{APP_VERSION}from"../../core/config.js?v=1.4.0";
  ...
  return`
    <section class="screen">
      ...
      <div class="page">
        ...
        <div class="panel version-panel"><div><small class="muted">ABYSS DOMINION</small><h3>REMAKE v${APP_VERSION}</h3><small class="muted">6枠編成UI / 分岐型297スキル / 新・深淵裏街</small></div></div>
