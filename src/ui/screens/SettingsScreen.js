import{APP_VERSION,CONTENT_TEST_MODE,CONTENT_TEST_UNLOCK_FLOOR}from"../../core/config.js?v=3.1.45-build365";
import{SERIAL_CODE_COUNT}from"../../core/SerialCodeSystem.js?v=3.1.45-build365";
