import{APP_VERSION,CONTENT_TEST_MODE,CONTENT_TEST_UNLOCK_FLOOR}from"../../core/config.js?v=3.1.50-build370";
import{SERIAL_CODE_COUNT}from"../../core/SerialCodeSystem.js?v=3.1.50-build370";
    ...
    <section class="screen settings-screen-v3">
      ...
      <div class="settings-page-v3">
        ...
        <div class="serial-code-panel settings-gm-console-v3 gm-master-panel">
          ...
          <small>100階想定パックは仲間・装備・資源の配布のみです（${state.gameMaster?.progressPack356?.claimedAt?"受取済み":"未受取"}）。旧支援コードの出発階層解放とは別に使用できます。</small>
          <small>最終決戦想定パック：十神2体・深淵2体と専用装備・資源（${state.gameMaster?.finalePack359?.claimedAt?"受取済み":"未受取"}）。階層・討伐記録・編成は変更しません。</small>
        </div>
