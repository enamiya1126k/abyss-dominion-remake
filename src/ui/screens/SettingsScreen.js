  ...
  return`
    <section class="screen">
      ...
      <div class="page">
        ...
        <div class="panel version-panel"><div><small class="muted">ABYSS DOMINION</small><h3>REMAKE v${APP_VERSION}</h3><small class="muted">全7ランク210種 / 累計EXP引き継ぎ / 部隊・育成UI改善</small></div></div>
