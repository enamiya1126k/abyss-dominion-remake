import{MonsterCard}from"../components/MonsterCard.js?v=1.7.0";
import{SPECIES}from"../../data/species.js?v=1.7.0";
import{displayName,totalExperience}from"../../models/Monster.js?v=1.7.0";
import{monsterCombatPower}from"../../core/CombatPower.js?v=1.7.0";
