import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.39-build359";
// Regression marker only: config.js?v=3.1.21-build340
// Regression history: CampaignHeroEncounterSystem.js?v=3.1.4-build323
import{displayName,calculatedStats}from"../../models/Monster.js?v=3.1.39-build359";
...
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.39-build359";
