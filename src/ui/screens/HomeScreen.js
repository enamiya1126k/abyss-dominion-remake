import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.37-build357";
// Regression marker only: config.js?v=3.1.21-build340
// Regression history: CampaignHeroEncounterSystem.js?v=3.1.4-build323
import{displayName,calculatedStats}from"../../models/Monster.js?v=3.1.37-build357";
import{maxMp}from"../../battle/SkillSystem.js?v=3.1.37-build357";
import{SPECIES}from"../../data/species.js?v=3.1.37-build357";
import{TEAM_BATTLE_UNLOCK_FLOOR,GAUNTLET_UNLOCK_FLOOR,EMERGENCY_UNLOCK_FLOOR,hasCleared1000,worldPhase}from"../../core/EndgameSystem.js?v=3.1.37-build357";
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.37-build357";
import{idleReturnPreview}from"../../core/ReturnRewardSystem.js?v=3.1.34-build354";
...
import{magicCircleMarkup}from"../../core/MagicCircleSystem.js?v=3.1.34-build354";
import{campaignDayForFloor,campaignHeroAdvance}from"../../core/Campaign100System.js?v=3.1.1-build311";
import{normalizeCampaignHeroInvasion}from"../../core/CampaignHeroEncounterSystem.js?v=3.1.32-build352";
import{normalizeCampaignReincarnationState,campaignReincarnationDifficultyMultiplier,campaignReincarnationFloorLimit}from"../../core/CampaignReincarnationSystem.js?v=3.1.32-build352";
