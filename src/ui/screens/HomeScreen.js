import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.36-build356";
// Regression marker only: config.js?v=3.1.21-build340
// Regression history: CampaignHeroEncounterSystem.js?v=3.1.4-build323
import{displayName,calculatedStats}from"../../models/Monster.js?v=3.1.36-build356";
import{maxMp}from"../../battle/SkillSystem.js?v=3.1.35-build355";
import{SPECIES}from"../../data/species.js?v=3.1.35-build355";
import{TEAM_BATTLE_UNLOCK_FLOOR,GAUNTLET_UNLOCK_FLOOR,EMERGENCY_UNLOCK_FLOOR,hasCleared1000,worldPhase}from"../../core/EndgameSystem.js?v=3.1.35-build355";
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.36-build356";
