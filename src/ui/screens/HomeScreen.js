import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.34-build354";
...
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.34-build354";
