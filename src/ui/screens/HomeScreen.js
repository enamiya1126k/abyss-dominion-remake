import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.47-build367";
...
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.47-build367";
