import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.33-build353";
// Regression marker only: config.js?v=3.1.21-build340
// Regression history: CampaignHeroEncounterSystem.js?v=3.1.4-build323
import{displayName,calculatedStats}from"../../models/Monster.js?v=3.1.33-build353";
...
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.33-build353";
