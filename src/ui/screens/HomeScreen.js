import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.31-build351";
...
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.31-build351";
