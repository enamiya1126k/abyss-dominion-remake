import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=2.6.2";
import{displayName}from"../../models/Monster.js?v=2.6.2";
import{SPECIES}from"../../data/species.js?v=2.6.2";
import{TEAM_BATTLE_UNLOCK_FLOOR,EMERGENCY_UNLOCK_FLOOR,hasCleared1000,worldPhase}from"../../core/EndgameSystem.js?v=2.6.2";
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=2.6.2";
import{idleReturnPreview}from"../../core/ReturnRewardSystem.js?v=2.6.2";
import{unreadNoticeIds}from"../../core/NoticeSystem.js?v=2.6.2";
import{monsterVisual}from"../MonsterVisual.js?v=2.6.2";
import{attributeVisual}from"../components/AttributeVisual.js?v=2.6.2";
import{magicCircleMarkup}from"../../core/MagicCircleSystem.js?v=2.6.2";
