import{APP_VERSION,isContentUnlocked}from"../../core/config.js?v=3.1.42-build362";
...
import{monsterCombatPower,partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=3.1.42-build362";
