import{equipmentDisplayRarity,equipmentRarityColor,equipmentStatLabel}from"../../data/equipment.js?v=2.3.1";
...
import{ENDGAME_BOSSES}from"../../core/EndgameSystem.js?v=2.3.1";
