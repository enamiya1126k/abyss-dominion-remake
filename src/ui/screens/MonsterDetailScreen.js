...
import{displayName,rankName,colorValue,calculatedStats,TRAITS,limitBreakGrowth,affectionBonuses,expNeedFor,totalExperience}from"../../models/Monster.js?v=2.10.0-build158";
import{monsterVisual}from"../MonsterVisual.js?v=2.10.0";
import{attributeVisual}from"../components/AttributeVisual.js?v=2.10.0";
import{normalizePersistentAilments,persistentAilmentLabel}from"../../data/statusEffects.js?v=2.10.0";
