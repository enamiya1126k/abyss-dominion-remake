...
import{displayName,rankName,colorValue,calculatedStats,TRAITS,limitBreakGrowth,affectionBonuses,expNeedFor,totalExperience}from"../../models/Monster.js?v=2.10.0-build159";
...
import{normalizePersistentAilments,persistentAilmentLabel}from"../../data/statusEffects.js?v=2.10.0-build159";
