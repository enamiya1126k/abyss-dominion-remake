import{APP_VERSION}from"../../core/config.js?v=2.4.0";
import{calculatedStats,displayName}from"../../models/Monster.js?v=2.4.0";
import{maxMp}from"../../battle/SkillSystem.js?v=2.4.0";
import{biomeForFloor,biomeProgress}from"../../data/biomes.js?v=2.4.0";
import{worldPresentationForFloor}from"../../core/WorldSystem.js?v=2.4.0";
import{partyCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=2.4.0";
import{manualReturnPreview}from"../../core/ReturnRewardSystem.js?v=2.4.0";
import{monsterVisual}from"../MonsterVisual.js?v=2.4.0";
import{SPECIES}from"../../data/species.js?v=2.4.0";
import{resourceHud,pixelIcon}from"../components/GameChrome.js?v=2.4.0";
