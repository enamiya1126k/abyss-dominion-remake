import{
 ...
 compatibleSubslots,
 equipmentIdentity
}from"../../data/equipment.js?v=2.10.0-build160";
import{displayName,calculatedStats}from"../../models/Monster.js?v=2.10.0-build160";
import{equipmentStatMultiplier}from"../../models/Equipment.js?v=2.10.0-build160";
import{maxMp}from"../../battle/SkillSystem.js?v=2.10.0-build160";
import{monsterCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=2.10.0-build160";
import{ATTRIBUTES}from"../../data/attributes.js?v=2.10.0-build160";
import{equipmentExpNeed}from"../../services/EquipmentEnhancement.js?v=2.10.0-build160";
import{weaponMasteryBadge}from"../../services/WeaponMastery.js?v=2.10.0-build160";
import{seriesMasterySummary}from"../../services/SeriesMastery.js?v=2.10.0-build160";
import{SPECIES}from"../../data/species.js?v=2.10.0-build160";
import{EQUIPMENT_SERIES,activeSeriesBonuses,describeSeriesEffect}from"../../data/equipmentSeries.js?v=2.10.0-build160";
import{EQUIPMENT_LIMIT,slotLabel,equipmentSellPrice as equipmentSellPriceForState}from"../../services/EquipmentStorage.js?v=2.10.0-build160";
import{ensureEquipmentAffixes,affixQuality,formatAffix,equipmentAffixPower,affixDefinition}from"../../data/equipmentAffixes.js?v=2.10.0-build160";
...
import{equipmentSocketSummary}from"../components/EquipmentSocketSummary.js?v=2.10.0-build160";
import{equipmentVisual}from"../components/EquipmentVisual.js?v=2.10.0-build160";
import{equippedMagicCircle}from"../../core/MagicCircleSystem.js?v=2.10.0-build160";
import{signatureWeaponState,signatureWeaponForMonster,signatureEquipmentOwnerName,signatureEquipmentMatchesMonster}from"../../core/SignatureWeaponSystem.js?v=2.10.0-build160";
