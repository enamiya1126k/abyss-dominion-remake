import{
 ...
 compatibleSubslots
}from"../../data/equipment.js?v=2.7.0";
import{displayName,calculatedStats}from"../../models/Monster.js?v=2.7.0";
import{equipmentStatMultiplier}from"../../models/Equipment.js?v=2.7.0";
import{maxMp}from"../../battle/SkillSystem.js?v=2.7.0";
import{monsterCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=2.7.0";
import{ATTRIBUTES}from"../../data/attributes.js?v=2.7.0";
import{equipmentExpNeed}from"../../services/EquipmentEnhancement.js?v=2.7.0";
import{weaponMasteryBadge}from"../../services/WeaponMastery.js?v=2.7.0";
import{seriesMasterySummary}from"../../services/SeriesMastery.js?v=2.7.0";
import{SPECIES}from"../../data/species.js?v=2.7.0";
import{EQUIPMENT_SERIES,activeSeriesBonuses,describeSeriesEffect}from"../../data/equipmentSeries.js?v=2.7.0";
import{EQUIPMENT_LIMIT,slotLabel,equipmentSellPrice as equipmentSellPriceForState}from"../../services/EquipmentStorage.js?v=2.7.0";
import{ensureEquipmentAffixes,affixQuality,formatAffix,equipmentAffixPower,affixDefinition}from"../../data/equipmentAffixes.js?v=2.7.0";
...
import{equipmentVisual}from"../components/EquipmentVisual.js?v=2.7.0";
import{equippedMagicCircle}from"../../core/MagicCircleSystem.js?v=2.7.0";
