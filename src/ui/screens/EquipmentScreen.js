import{
 ...
 compatibleSubslots,
 equipmentIdentity
}from"../../data/equipment.js?v=2.10.0-build161";
...
import{monsterCombatPower,formatCombatPower}from"../../core/CombatPower.js?v=2.10.0-build161";
import{ATTRIBUTES}from"../../data/attributes.js?v=2.10.0-build161";
import{equipmentExpNeed}from"../../services/EquipmentEnhancement.js?v=2.10.0-build161";
import{weaponMasteryBadge}from"../../services/WeaponMastery.js?v=2.10.0-build161";
import{seriesMasterySummary}from"../../services/SeriesMastery.js?v=2.10.0-build161";
import{SPECIES}from"../../data/species.js?v=2.10.0-build161";
import{EQUIPMENT_SERIES,activeSeriesBonuses,describeSeriesEffect}from"../../data/equipmentSeries.js?v=2.10.0-build161";
import{EQUIPMENT_LIMIT,slotLabel,equipmentSellPrice as equipmentSellPriceForState}from"../../services/EquipmentStorage.js?v=2.10.0-build161";
import{ensureEquipmentAffixes,affixQuality,formatAffix,equipmentAffixPower,affixDefinition}from"../../data/equipmentAffixes.js?v=2.10.0-build161";
...
import{equippedMagicCircle}from"../../core/MagicCircleSystem.js?v=2.10.0-build161";
import{signatureWeaponState,signatureWeaponForMonster,signatureEquipmentOwnerName,signatureEquipmentMatchesMonster}from"../../core/SignatureWeaponSystem.js?v=2.10.0-build161";
