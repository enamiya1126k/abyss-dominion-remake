import{ROYAL_ASSET,createRoyalWorld,royalHeroPositions,royalContact}from'../core/RoyalChamberSystem.js?v=3.1.40-build360';
...
export function mountRoyalChamber(g,{canvas,Entity,Camera,findPath,drawMonster,TILE,room,party,heroes,onSave,onApproach,onContact,onThrone,blocked=()=>false}){
 ...
 const activeHeroes=['victory','cleared'].includes(room.phase)?[]:heroActors;
