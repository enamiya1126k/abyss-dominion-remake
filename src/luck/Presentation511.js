import {LUCK511,metres511} from './Rules511.js';
...
export function banner511(g,self){if(g.phase==='dice')return{title:'',sub:''};if(g.phase==='hand'&&g.round===8)return{title:g.ownPick!=null?'最後の一手、セット。':'育てた力、解き放て。',sub:'この4枚には、必ず大技が1枚以上。'};return banner510(g,self)}
