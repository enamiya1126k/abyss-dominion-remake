...
export function sound510(c,kind){const u=c.lkUI510;if(!u?.sound||u.reduced||c.save?.state.settings?.audioEnabled===false||globalThis.document?.visibilityState==='hidden')return;
