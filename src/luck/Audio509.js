...
export function sound509(c,kind){const u=c.lkUI509;if(!u?.sound||u.reduced||c.save?.state.settings?.audioEnabled===false||globalThis.document?.visibilityState==='hidden')return;
 ...
 const notes={finish:[523,659,784,1047],open:[330,440,660],launch:[90,180,360,720],count:[600],attack:[440,220],hit:[100,60],guard:[620,930],reflect:[400,800,1200],settle:[520,780],pick:[480,720]}[kind]??[440];
