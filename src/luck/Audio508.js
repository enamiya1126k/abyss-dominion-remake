...
export function sound508(c,kind){const u=c.lkUI508;if(!u?.sound||u.reduced||c.save?.state.settings?.audioEnabled===false||globalThis.document?.visibilityState==='hidden')return;
