...
export function flushCanal489(c,u,game,now){
 ...
 if(c.raw('canalInput489',{gameId:game.id,inputs:batch.map(({seq,lane,held,pulse,burst,targetId})=>({seq,lane,held,pulse,burst,...(targetId!=null?{targetId}:{})}))})===false)return;
