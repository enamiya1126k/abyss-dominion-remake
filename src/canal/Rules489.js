...
export function startCanal489(g,now){
...
export function sweep489(g,p,lane,at,burst=false){
...
export function inputCanal489(g,p,input,receivedAt){
...
export function advanceCanal489(g,now,connected=()=>true){
