...
export function layout496(enemies,at,width,height){const size=Math.max(42,Math.min(80,width*.175,height*.15));return enemies.map(e=>{const progress=progress496(e,at),s=size*(e.kind===3?(e.path500===1?4:1.18):1);return{...e,...point496(e,progress,width,height),progress,size:s,touchSize:Math.max(52,s),eta:remaining496(e,at)}})}
