...
export function abilityPresentation473(e,art,height,source,actor){
 ...
 const awake=e.kind==='awaken',small=height<340,baseHeight=166*88/63,portraitH=Math.max(58,Math.min(baseHeight,height-(small?44:124))),scale=portraitH/baseHeight,w=166*scale;
