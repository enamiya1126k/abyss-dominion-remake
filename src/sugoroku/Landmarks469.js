...
export const LANDMARKS469={
 '8':{x:935,y:205,name:'月影の神殿',kind:'gate',icon:'✧',tone:'gold',text:'初回は必ず停止（残り移動は消滅）。2回目以降は通過可。覚醒能力がなければ獲得、あれば安全に1枚。さらに未所持の絵柄を1種獲得。',effects:[{type:'shrine469'},{type:'piece'}]},
 '31':{x:1390,y:948,name:'蒼晶の書庫',kind:'gate',icon:'✧',tone:'gold',text:'初回は必ず停止（残り移動は消滅）。2回目以降は通過可。覚醒能力がなければ獲得、あれば安全に1枚。さらに未所持の絵柄を1種獲得。',effects:[{type:'shrine469'},{type:'piece'}]},
 ...
 '63':{x:324,y:2150,name:'星冠の神殿',kind:'gate',icon:'✧',tone:'gold',text:'初回は必ず停止（残り移動は消滅）。2回目以降は通過可。覚醒能力がなければ獲得、あれば安全に1枚。さらに未所持の絵柄を1種獲得。',effects:[{type:'shrine469'},{type:'piece'}]}
};
