import{SAVE_KEY,APP_VERSION,MAX_PARTY_SIZE,TRUE_MAX_LEVEL}from"../core/config.js?v=1.7.7-final";
...
export class SaveService{
 ...
 migrate(s){
  ...
  if(from<42)s.lastMigration={from,to:42,at:new Date().toISOString()};
  return s
 }
 save(){
