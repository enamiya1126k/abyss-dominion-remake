import{SAVE_KEY,APP_VERSION}from"../core/config.js?v=0.9.15-alpha.2-part2";
...
export class SaveService{
 ...
 migrate(s){
  ...
  if(from<21)s.lastMigration={from,to:21,at:new Date().toISOString()};
  return s
 }
