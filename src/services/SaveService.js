...
export class SaveService{
 ...
 migrate(s){
  ...
  s.codex??={};s.codex.encounters??={};s.codex.captures??={};s.codex.equipment??={};s.biomeProgress??={};s.achievements??={};s.quests??={};
  ...
  if(from<13)s.lastMigration={from,to:13,at:new Date().toISOString()};
  return s
 }
