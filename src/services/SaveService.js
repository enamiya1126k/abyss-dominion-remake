import{SAVE_KEY,APP_VERSION,MAX_PARTY_SIZE,TRUE_MAX_LEVEL}from"../core/config.js?v=1.7.0";
import{createMonster,totalExperience,applyTotalExperience}from"../models/Monster.js?v=1.7.0";
import{maxMp,normalizeSkillProgress,allLearnedSkills}from"../battle/SkillSystem.js?v=1.7.0";
...
import{normalizeCombatPowerRecord}from"../core/CombatPower.js?v=1.7.0";
...
export class SaveService{
 ...
 migrate(s){
  ...
  if(from<38)s.lastMigration={from,to:38,at:new Date().toISOString()};
  return s
 }
 save(){
