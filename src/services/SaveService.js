import{SAVE_KEY,APP_VERSION,SAVE_SCHEMA_VERSION,MAX_PARTY_SIZE,TRUE_MAX_LEVEL,MONSTER_STAR_MAX,normalizeBattleSpeed}from"../core/config.js?v=2.2.1-hotfix";
import{createMonster,totalExperience,applyTotalExperience}from"../models/Monster.js?v=2.2.1-hotfix";
import{maxMp,normalizeSkillProgress,allLearnedSkills}from"../battle/SkillSystem.js?v=2.2.1-hotfix";
import{normalizeEndgameState,ENDGAME_BOSSES}from"../core/EndgameSystem.js?v=2.2.1-hotfix";
import{normalizeSecondWorldEvents}from"../core/SecondWorldEventSystem.js?v=2.2.1-hotfix";
import{normalizeEliteRecords}from"../core/SecondWorldEliteSystem.js?v=2.2.1-hotfix";
import{normalizeTenGodContact}from"../core/TenGodContactSystem.js?v=2.2.1-hotfix";
import{SPECIES}from"../data/species.js?v=2.2.1-hotfix";
import{isPersistentStatus,normalizePersistentAilments}from"../data/statusEffects.js?v=2.2.1-hotfix";
import{normalizeWeaponMastery}from"./WeaponMastery.js?v=2.2.1-hotfix";

import{normalizeReturnRewards}from"../core/ReturnRewardSystem.js?v=2.2.1-hotfix";
import{createAbyssSkillTreeState,normalizeAbyssSkillTree}from"../core/AbyssSkillTreeSystem.js?v=2.2.1-hotfix";
import{normalizeEquipmentLoadouts}from"./EquipmentLoadoutSystem.js?v=2.2.1-hotfix";
import{normalizeEquipmentAffixLocks,normalizeEquipmentCraftingState}from"./EquipmentAffixCrafting.js?v=2.2.1-hotfix";
import{normalizeSecretRoomState}from"../core/SecretRoomSystem.js?v=2.2.1-hotfix";
import{normalizeCombatPowerRecord}from"../core/CombatPower.js?v=2.2.1-hotfix";
import{normalizeSerialCodeState}from"../core/SerialCodeSystem.js?v=2.2.1-hotfix";
import{normalizeNoticeState}from"../core/NoticeSystem.js?v=2.2.1-hotfix";
