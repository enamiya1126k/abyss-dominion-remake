import{SAVE_KEY,APP_VERSION,MAX_PARTY_SIZE,TRUE_MAX_LEVEL}from"../core/config.js?v=1.7.6-cachefix";
...
export class SaveService{
 ...
 migrate(s){
  ...
  if(from<41)s.lastMigration={from,to:41,at:new Date().toISOString()};
  return s
 }
 save(){
