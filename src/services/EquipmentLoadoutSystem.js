import{SLOT_UNLOCK_LEVEL,compatibleSubslots,EQUIPMENT_SLOT_ORDER}from"../data/equipment.js?v=2.10.0-build163";
import{signatureEquipmentOwnerId,signatureEquipmentMatchesMonster}from"../core/SignatureWeaponSystem.js?v=2.10.0-build163";
import{equipmentRequiredMonsterLevel}from"../models/Equipment.js?v=2.10.0-build163";
