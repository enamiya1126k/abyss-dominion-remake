...
import{signatureEquipmentOwnerId,signatureEquipmentMatchesMonster}from"../core/SignatureWeaponSystem.js?v=3.1.41-build361";
import{equipmentRequiredMonsterLevel}from"../models/Equipment.js?v=3.1.41-build361";
