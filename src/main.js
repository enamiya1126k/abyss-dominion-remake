...
const ONLINE_WEEKLY_RAID_REWARDS=Object.freeze({
 "abyss-amalga":Object.freeze({name:"終焉融骸・アビス＝マルガ",contractName:"融骸幼体アマルガ",speciesId:"ancient_dragon",attribute:"dark",visualBase:"./assets/online/raid/juvenile-amalga",equipmentName:"終焉喰らいの大刃",circleId:"death_mirror",circleName:"即死返鏡陣"}),
...
function persistOnlineBattleDefeated(event={}){
 ...
 const worldOwnerId=String(event.worldOwnerId??"").slice(0,24),selfId=String(onlinePartyController?.selfId??""),ownsWorld=Boolean(worldOwnerId)&&worldOwnerId===selfId;
