...
function win(caught,m){
 ...
 save.save();if(snapshot?.enemies)snapshot.enemies=snapshot.enemies.filter(x=>x!==activeEnemy);activeEnemy=null;document.querySelector(".battle-screen")?.remove();
