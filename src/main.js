...
import{beginManualExpedition,recordManualFloorClear,claimManualReturn,abandonManualExpedition,idleReturnPreview,claimIdleReturn}from"./core/ReturnRewardSystem.js?v=0.9.15-alpha.38-idle-return-equipment-phase1";
...
function bindExplore(){
 ...
 document.getElementById("returnHome").onclick=()=>{
  ...
  app.insertAdjacentHTML("beforeend",Modal("探索帰還報告",`<div class="return-reward-report">${highlight}<p><b>${result.startFloor}F → ${result.endFloor}F</b></p><p>踏破階層 <b>${result.floorsCleared}階</b></p><p>獲得GOLD <b>${result.gold.toLocaleString()}G</b></p><h3>獲得装備 ${result.equipment.length}個</h3><div class="return-reward-items">${equipmentRows}</div></div>`,"拠点へ戻る"));
