...
import{OnlinePartyScreen}from"./ui/screens/OnlinePartyScreen.js?v=2.11.69-build245";
import{OnlinePartyController}from"./online/OnlinePartyClient.js?v=2.11.69-build245";
...
function claimOnlinePartyReward({rewardId,reward={},source={}}={}){
 ...
 return{ok:true,gold,goldCost,captureCrystals,crystals,abyssKeys,abyssKeyCost,potions,raidMaterials,experience,experienceTarget,equipmentName,equipmentSlot,equipmentKindLabel,isWeapon,isImportantEquipment,captureSuccess,captureStorageFull,captureNoCrystal,captureName,leaderFloorUnlock}
}
