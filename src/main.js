...
import{beginManualExpedition,recordManualFloorClear,claimManualReturn,abandonManualExpedition}from"./core/ReturnRewardSystem.js?v=0.9.15-alpha.36-return-equipment-phase1";
