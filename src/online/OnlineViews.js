import{expandedPower445}from"../core/PowerScale445.js";
...
export function renderOnlineTeam(room, selfId, state = {}) {
  ...
  const teamPower = members => members.reduce((sum, member) => sum + expandedPower445(member.profile?.power), 0);
