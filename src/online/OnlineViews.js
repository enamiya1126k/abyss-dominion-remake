import{displayPower446}from"../core/PowerScale446.js";
...
export function renderOnlineTeam(room, selfId, state = {}) {
  ...
  const teamPower = members => members.reduce((sum, member) => sum + displayPower446(member.profile?.power), 0);
