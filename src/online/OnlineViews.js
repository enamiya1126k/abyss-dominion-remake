import{displayPower448}from"../core/PowerScale448.js";
...
export function renderOnlineTeam(room, selfId, state = {}) {
  ...
  const teamPower = members => members.reduce((sum, member) => sum + displayPower448(member.profile?.power,member.profile), 0);
