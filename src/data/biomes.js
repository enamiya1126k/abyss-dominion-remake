...
export const BIOMES=[
 ...
 {id:"frozen_corridor",name:"氷結回廊",icon:"❄️",from:31,to:40,theme:"ice",accent:"#77cfff",description:"音さえ凍る青白い回廊。",elements:["ice","wind"]},
 ...
 {id:"abyss_gate",name:"深淵入口",icon:"🌌",from:51,to:60,theme:"abyss",accent:"#9d7cff",description:"ここから先は光が届かない。",elements:["dark","water","light"]},
 {id:"nether",name:"奈落",icon:"☠️",from:61,to:100,theme:"nether",accent:"#c56cff",description:"深淵種が徘徊する底なしの領域。",elements:["dark","earth","fire"]},
];
const DEEP_BIOME_CYCLE=Object.freeze([
 ...
 {name:"瘴毒菌層",theme:"poison",accent:"#9bdd55",description:"猛毒の胞子が漂う瘴気の五十階層。",elements:["dark","earth","water"]},
 {name:"雷鳴天層",theme:"lightning",accent:"#d7b8ff",description:"絶え間なく雷が走る雷の五十階層。",elements:["lightning","wind"]},
 ...
 {name:"混沌境層",theme:"chaos",accent:"#ff6cae",description:"複数の法則が衝突する混沌の五十階層。",elements:["fire","water","light","dark","lightning"]}
]);
