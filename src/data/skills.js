export const SKILLS={
 ...
 goblin_double:{id:"goblin_double",name:"二段斬り",mp:3,cooldown:1,type:"multiAttack",power:.72,hits:2,description:"敵単体へ72%の攻撃を2回。"},
 ...
 goblin_poison:{id:"goblin_poison",name:"毒刃乱舞",mp:9,cooldown:3,type:"multiAttack",power:.65,hits:4,status:{id:"poison",name:"毒",chance:.8,turns:4,power:.035},description:"敵単体へ65%の攻撃を4回。"},
 goblin_general:{id:"goblin_general",name:"将軍の一閃",mp:10,type:"attack",power:2.45,description:"敵単体へ245%の物理ダメージ。"},

 fairy_heal:{id:"fairy_heal",name:"癒やしの風",mp:5,cooldown:2,type:"allHeal",heal:.25,description:"味方全体の最大HPの25%を回復。"},
 ...
 fairy_revive:{id:"fairy_revive",name:"生命の雫",mp:12,cooldown:4,type:"allHeal",heal:.5,description:"味方全体の最大HPの50%を回復。"},
 ...
 dragon_fireball:{id:"dragon_fireball",name:"火炎弾",mp:8,cooldown:2,type:"attack",power:2.2,status:{id:"burn",name:"炎上",chance:.65,turns:3,power:.05},description:"敵単体へ220%の高威力攻撃。"},
 dragon_roar:{id:"dragon_roar",name:"竜の咆哮",mp:7,type:"attack",power:1.45,description:"敵単体へ145%の衝撃ダメージ。"},
 dragon_vortex:{id:"dragon_vortex",name:"火焔渦",mp:11,cooldown:3,type:"multiAttack",power:.85,hits:3,status:{id:"burn",name:"炎上",chance:.85,turns:4,power:.055},description:"敵単体へ85%の攻撃を3回。"},
 dragon_ancient:{id:"dragon_ancient",name:"古龍覚醒",mp:16,cooldown:4,type:"attack",power:3.1,description:"敵単体へ310%の極大ダメージ。"},

 mushroom_spore:{id:"mushroom_spore",name:"毒胞子",mp:3,cooldown:1,type:"attack",power:1.3,status:{id:"poison",name:"毒",chance:.7,turns:3,power:.03},description:"敵単体へ130%の攻撃。"},
 mushroom_cloud:{id:"mushroom_cloud",name:"胞子雲",mp:5,cooldown:2,type:"attack",power:1.55,status:{id:"poison",name:"毒",chance:.85,turns:4,power:.035},description:"敵単体へ155%の攻撃。"},
 mushroom_drain:{id:"mushroom_drain",name:"腐食吸収",mp:7,type:"drain",power:1.35,drain:.5,description:"与えたダメージの50%を回復。"},
 mushroom_plague:{id:"mushroom_plague",name:"疫病庭園",mp:10,cooldown:4,type:"multiAttack",power:.7,hits:4,status:{id:"poison",name:"猛毒",chance:1,turns:5,power:.05},description:"敵単体へ70%の攻撃を4回。"},
