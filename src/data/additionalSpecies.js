...
const FEATURED=[
 ...
 species({id:"dev_familiar_chappy",name:"開発使魔チャッピー",emoji:"🛠️",element:"neutral",race:"construct",role:"balanced",rarity:"SECRET",minFloor:10000,maxMp:130,captureRate:0,fieldEncounter:false,serialOnly:true,gachaExcluded:true,stats:{hp:404,atk:130,def:130,spd:130,crit:13,evasion:13},acquisition:["シリアル限定"],skills:[skill("chappy_patch","PATCH//404",{mp:4,power:4.04,allEnemies:true,target:"敵全体",description:"未完成のはずなのに妙に強い開発者権限。"})]})
];
