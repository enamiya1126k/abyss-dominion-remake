...
export const MYTHIC_SERIAL_SPECIES=Object.freeze({
  myth_enami:mythic({
    ...
    skills:[
      skill("enami_world_create","メンタル！！",{mp:11,power:1.65,allEnemies:true,target:"敵全体",damageClass:"magic",effects:[{kind:"vulnerable",value:.25,turns:3,enemy:true}],description:"敵全体へ魔法攻撃。被ダメージを25%増加させる（3ターン）。"}),
  ...
  myth_rion:mythic({
    ...
    skills:[
      skill("rion_talk","いこうぜ！",{mp:8,power:1.2,allEnemies:true,target:"敵全体",reducePartyCooldowns:1,damageClass:"magic",effects:[{kind:"defDown",value:.25,turns:3,enemy:true},{kind:"spdDown",value:.25,turns:3,enemy:true}],description:"敵全体へ魔法攻撃。防御・速度25%低下（3ターン）。味方の再使用を1ターン短縮（1ラウンド1回）。"}),
  ...
  myth_yori:mythic({
    ...
    skills:[
      ...
      skill("yori_tetrapod","開けんかいコラァ！",{level:45,mp:20,power:2.5,allEnemies:true,target:"敵全体",defenseIgnore:.50,bonusVsEffect:{kind:"vulnerable",multiplier:1.2},noLifeSteal:true,description:"敵全体へ防御50%無視の物理攻撃。被ダメージ増加中なら威力1.2倍。"}),
  ...
  myth_hide:mythic({
    ...
    skills:[
      skill("hide_crayfish","フォー！！！！",{mp:9,power:1.55,allEnemies:true,target:"敵全体",damageClass:"magic",effects:[{kind:"accuracyDown",value:.25,turns:3,enemy:true}],description:"敵全体へ魔法攻撃。命中25%低下（3ターン）。"}),
