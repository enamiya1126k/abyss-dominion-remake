...
import{TRUE_MAX_LEVEL,ENDGAME_MAX_LEVEL,MONSTER_STAR_MAX}from"../core/config.js?v=3.1.41-build361";
import{baseExperienceNeedForLevel}from"../core/ProgressionSystem.js?v=3.1.41-build361";
