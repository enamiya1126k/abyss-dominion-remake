...
import{normalizedResistances}from"../data/attributes.js?v=2.6.0";
import{activeSeriesBonuses}from"../data/equipmentSeries.js?v=2.6.0";
import{normalizePersistentAilments}from"../data/statusEffects.js?v=2.6.0";
import{TRUE_MAX_LEVEL,ENDGAME_MAX_LEVEL,MONSTER_STAR_MAX}from"../core/config.js?v=2.6.0";
