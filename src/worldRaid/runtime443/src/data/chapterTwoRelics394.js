...
export const CHAPTER_TWO_CIRCLES394=Object.freeze([
 circle(0,'chain','鏡糸連環陣','連','rose',{chain:[.35,.55]},'同一ラウンドで、同じ敵への2撃目以降の直接与ダメージが増加。命中してHPを削った攻撃を数える。'),
 circle(1,'dream','夢喰封花陣','夢','violet',{sleep:[.60,.90]},'睡眠中の敵への直接与ダメージが増加。睡眠が解けると特効も終了。'),
 circle(2,'pair','双誓共鳴陣','誓','gold',{pair:[.45,.70]},'指定ペアが生存し連携可能な間、装着者が行うペア追撃・合体魔法の与ダメージが増加。'),
 circle(3,'guard','天鎖護誓陣','護','blue',{guard:[.20,.30],counter:[.45,.70]},'ガード中の敵からの直接攻撃を軽減し、既存の反撃の与ダメージを強化。反撃自体は追加しない。'),
 circle(4,'crown','終冠星律陣','冠','gold',{execute:[.45,.70]},'残りHP35%以下の敵への直接与ダメージが増加。各命中の直前のHPで判定。')
]);
