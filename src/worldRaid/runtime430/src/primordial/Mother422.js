...
export function tuneMother422(enemy){Object.assign(enemy,{name:'原母イオネア',maxHp:1600000,hp:1600000,atk:14000,matk:14000,def:6500,mdef:7000,spd:8000,maxMp:720,currentMp:720,motherRevision423:423,motherRevision424:424,motherRevision426:426,accuracy:112,evasion:8,crit:8,hiddenDamageTaken:1,hiddenStatusResist:0,hiddenProfile:{active:false},divineBarrier:0,bossStatusResist:.15,bossHealRate:0,bossPowerMultiplier:1,chapterTwoTactics382:{area:4,role:'striker',actions:skills.map(s=>s.id),hint:MOTHER_SPECIES422.counter383}});return enemy;}
