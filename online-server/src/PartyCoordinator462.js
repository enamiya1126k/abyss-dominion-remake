...
export function handleParty462(c,session,m){
 ...
 if(m.op==='partyKick485'){
  ...
  if(r){r.updatedAt=c.now();if(r.game==='tetra'||r.game==='hide'||r.game==='fishing'||r.game==='sumo'||r.game==='tower'||r.game==='quiz'||r.game==='luck'||r.game==='gorilla'||r.game==='canal'||r.game==='sugoroku'||r.game==='cabbage')r.revision=(r.revision??0)+1}
  return true;
 }
