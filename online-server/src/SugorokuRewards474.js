...
export function handleCrystal474(c,session,m){
 ...
 if(Number(m.rulesVersion)<15||!validFee474(m.amount)||!/^sg463-\d+-[a-f0-9]{8}$/.test(m.gameId)||!/^[\w-]{8,100}$/.test(m.requestId))throw Error('参加情報を確認してください');
