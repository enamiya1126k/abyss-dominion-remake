...
import {WorldRaidCoordinator430} from "./src/WorldRaidCoordinator430.js";
...
const battleClock=setInterval(()=>{store.advanceBattles();worldRaid.advance()},250);battleClock.unref?.();
