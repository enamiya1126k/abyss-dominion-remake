...
wss.on("connection",socket=>{
 ...
 socket.on("message",raw=>{
  ...
  if(monsterRace451.active(session.playerId)&&(WORLD_RAID_BUSY_REQUESTS.has(message.type)||["worldRaidStart","worldRaidReserve430"].includes(message.type)))return fail(socket,{code:"MONSTER_RACE_ACTIVE",message:"魔物レースが終わるまでお待ちください"});
